...
namespace ChatServer
{
    ...
    internal class Program
    {
        ...
        private static ObjectPool<PoolableMemoryStream> _packetHandlerPool =
        new ObjectPool<PoolableMemoryStream>(
            initialSize: 15,    // 초기 15개 생성
            maxSize: 75,       // 최대 75개까지 보관
            growSize: 10        // 부족할 때 10개씩 추가 생성
        );

        // ✅ Public static 프로퍼티로 외부 접근 허용
        public static ObjectPool<PoolableMemoryStream> PacketHandlerMemoryStreamPool
        {
            get { return _packetHandlerPool; }
        }
        ...
        private static void StartListening()
        {
            ...
            SaveConfig(serverIP, serverPort, "..\\..\\..\\..\\GGMClient\\bin\\x64\\Debug\\config.txt");
